...
export default function Footer({ theme, stats, t, locale }: FooterProps) {
  ...
  return (
    <footer
      className={`border-t ${
        isDark ? 'border-white/10' : 'border-black bg-white'
      }`}
    >
      <PageContainer className="py-8 flex flex-col md:flex-row justify-between items-start gap-12">
        ...
        <div className="flex flex-col md:items-end gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://github.com/p-carrillo/project_silicon-traveler"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
              className={`transition-opacity hover:opacity-100 ${
