  ...
  en: {
    ...
    admin: {
      ...
      errors: {
        ...
        photoRequired: 'Please select a JPEG or PNG file.',
        photoType: 'Only JPEG or PNG is supported right now.',
  ...
  es: {
    ...
    admin: {
      ...
      errors: {
        ...
        photoRequired: 'Selecciona un archivo JPEG o PNG.',
        photoType: 'Por ahora solo se admite JPEG o PNG.',
